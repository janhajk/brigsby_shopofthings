...
function sot_show_product_meta_custom() {
      ...
      if ($produktkennzeichen) {
          ...
          if (!empty($all_elements)) {
              echo '<tr style="line-height: 4em; border-bottom:1px solid gray;border-top:1px solid gray"><td colspan="2" style="text-align: center; vertical-align: middle;"><div style="display: flex; align-items: center; justify-content: space-between; height: 100%;padding:10px 0px">' . implode(' ', $all_elements) . '</div></td></tr>';
          }
      }
