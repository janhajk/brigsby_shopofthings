...
if ( hoot_page_header_attop() ) {
	get_template_part( 'template-parts/loop-meta-no-extras' ); // Loads the template-parts/loop-meta.php template to display Title Area with Meta Info (of the loop)
...
<div class="hgrid main-content-grid">
	...
	<main <?php hybridextend_attr( 'content' ); ?>>
		...
		if ( have_posts() ) :
			...
			if ( ! hoot_page_header_attop() ) {
				hoot_display_loop_title_content( 'post', 'page.php' );
				get_template_part( 'template-parts/loop-meta-no-extras' ); // Loads the template-parts/loop-meta-no-extras.php template to display Title Area with Meta Info (of the loop)
			}
			?>
